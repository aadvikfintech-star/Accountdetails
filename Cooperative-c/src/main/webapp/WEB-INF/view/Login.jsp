...
<div style="background-color: #f4f4f4;">
   <header class="main-header">
    <a style="width:250px !important;background-color: #3c8dbc;" href="login" class="logo"><b>Account Details</b></a>
		...
		<div class="box box-primary" style="margin-bottom: 0px !important;">
			<div class="box-body">
				<form:form method="post" action="login">
					<div class="row">
						<div class="col-md-5">
							<!--  <img src="resources/img/login_logo_new.png" alt="Image" class="img-fluid">  -->
						</div>
